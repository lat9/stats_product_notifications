...
define('TABLE_HEADING_VIEWED', 'Count');

define('TEXT_SHOWHIDE_HIDE_ALL', 'Hide all');
define('TEXT_SHOWHIDE_SHOW_ALL', 'Show all');
define('TEXT_SHOWHIDE_HIDE', 'Hide');
define('TEXT_SHOWHIDE_SHOW', 'Show');
